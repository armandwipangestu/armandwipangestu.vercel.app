...
export function HeroSection() {
    ...
    return (
        ...
        >
            ...
            {/* Layer 1: Base + Gradient - Light Mode */}
            <div
                className="absolute inset-0 z-0 dark:hidden"
                style={{
                    background:
                        "linear-gradient(to bottom, white, white), radial-gradient(ellipse 80% 50% at 50% 0%, rgba(59, 130, 246, 0.15), transparent 50%)",
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(59, 130, 246, 0.15), transparent 50%)",
                }}
            />

            {/* Layer 1: Base + Gradient - Dark Mode */}
            <div
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(120, 119, 198, 0.25), transparent 50%)",
                }}
            />

            {/* Layer 2: Dot Pattern - Light Mode */}
            <div
                className="absolute inset-0 z-0 dark:hidden"
                style={{
                    backgroundImage:
            ...
            <div className="relative z-10 section-container py-20">
                <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center w-full">
                    ...
                    <div className="lg:col-span-3 order-2 lg:order-1">
                        ...
                        >
                            <div className="px-4 py-3 rounded-lg bg-card/80 backdrop-blur-sm border border-border">
